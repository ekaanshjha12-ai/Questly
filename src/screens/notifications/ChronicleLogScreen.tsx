...
const STYLE: Record<string, { icon: LucideIcon; label: string; tone: string }> = {
  ...
  post_appreciated: { icon: HandHeart, label: 'Adventure Log', tone: 'text-reward-400 border-reward-500/40 bg-reward-500/10' },
  post_comment: { icon: MessageSquare, label: 'Adventure Log', tone: 'text-info-400 border-info-400/40 bg-info-400/10' },
